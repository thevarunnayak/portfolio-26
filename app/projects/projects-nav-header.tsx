...
export function ProjectsNavHeader({ totalCount }: { totalCount: number }) {
      ...
      <div className="mx-auto flex max-w-6xl items-center justify-between px-6 py-4">
        ...
        <div className="flex items-center gap-3 font-mono text-xs">
          <span className="hidden sm:inline-block rounded-full bg-blue-500/20 px-3 py-1 text-blue-400 border border-blue-500/30 font-semibold uppercase">
            FULL ARCHIVE ({totalCount})
          </span>
          <span className="hidden sm:inline text-neutral-500">•</span>
          <span className="hidden sm:inline text-[var(--text-muted)]">ENGINEERED PRODUCTS</span>
